...
std::vector<ofxBlob> ofxBlobTracker::getTrackedBlobs(){
    return trackedBlobs;
}

std::vector<ofxBlob> ofxBlobTracker::getTrackedFingers(){
...
**************************************************************************/
//int ofxBlobTracker::trackKnn(ContourFinder *newBlobs, Blob *track, int k, double thresh = 0){
int ofxBlobTracker::trackKnn(ofxContourFinder *newBlobs, ofxBlob *track, int k, double thresh , bool fing){
